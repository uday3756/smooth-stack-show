"use client";
/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-this-alias -- vendored WebGL mini-library uses dynamic uniform/attribute shapes and closure-scoped `this` */
